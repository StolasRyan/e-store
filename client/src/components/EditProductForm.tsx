...
import { ArrowLeftIcon, FileTextIcon, SaveIcon, TypeIcon } from "lucide-react";
        ...
        <div className="card-body">
          ...
          >
            ...
            <div className="form-control">
                <div className="flex items-start gap-2 p-3 rounded-box bg-base-200 bprder border-base-300">
