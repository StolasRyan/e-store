...
import { ArrowLeftIcon, CalendarIcon, EditIcon, TrashIcon, UserIcon } from "lucide-react";
...
const ProductPage = () => {
  ...
  if (isLoading) return <LoadingSpinner reference="Product Details" />;
  return (
              ...
              <div className="flex items-center gap-3">
                <div className="avatar">
                  <div className="w-12 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                    <img src={product.user.imageUrl} alt={product.user.name || 'Creator'} />
                  </div>
                </div>
                <div>
                  <p className="font-semibold">{product.user.name || "Anonymous"}</p>
