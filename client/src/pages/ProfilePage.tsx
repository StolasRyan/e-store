...
const ProfilePage = () => {
  ...
  if (isLoading) return <LoadingSpinner reference="Your profile"/>;
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="">
          ...
          <p className="text-sm text-base-content/50">Manage your listings</p>
        </div>
      ...
      <div className="stats bg-base-300 w-full">
          <div className="stat">
            <div className="stat-title">{`${products?.length === 1 ? "Product" : "Products"}`}</div>
